...
printf "${CYAN}\r\n********************\r\n********************\r\n** 💡 PHPMD ********\r\n********************\r\n********************\r\n\r\n${NC}"
docker exec -u root -it "fiftydeg_sylius_cache_plugin_php" bash -c "XDEBUG_MODE=off php vendor/bin/phpmd src,tests/Behat github phpmd.ruleset.xml"

printf "${CYAN}\r\n********************\r\n********************\r\n** 💡 CONTAINER ****\r\n********************\r\n********************\r\n\r\n${NC}"
docker exec -u root -it "fiftydeg_sylius_cache_plugin_php" bash -c "cd tests/Application && XDEBUG_MODE=off php bin/console lint:container"
